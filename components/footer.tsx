...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="p-10 pt-16 bg-btn-cta text-white relative overflow-clip">
                    ...
                    <div key={section.title} className="flex flex-col gap-3 text-lg">
                        ...
                        <ul className="flex flex-col gap-1">
                            {section.links.map((link) => (
                                <li key={link.name}>
                                    <Link href={link.path} className="hover:underline" id={link.testId ? link.testId : undefined}>
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
            ...
            <img
                ...
                className="absolute -bottom-3 right-0 w-32 md:w-52 h-auto pointer-events-none"
            />
