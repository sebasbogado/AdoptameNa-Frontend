...
const PostButtons = ({ isPet = false, postId, onShare, postIdUser, sizeButton, petStatus }: PostButtonsProps) => {
    ...
    return (
        <div className="flex flex-wrap justify-start gap-2 sm:gap-3 px-2 sm:px-4 md:px-0 md:pr-4 lg:pr-12 relative mt-4 sm:mt-0"> {/* Añadido mt-4 sm:mt-0 para cuando está debajo del PostHeader en mobile */}
