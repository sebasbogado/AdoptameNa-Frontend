...
const DropdownContactButton: React.FC<Props> = ({
    variant = "cta",
    size = "md",
    className,
    handleContactClick,
            ...
            >
                <DropdownMenu.Item>
                    <button
                        ...
                        className={
                            `flex items-center gap-x-2 w-full px-3 py-2 rounded-md ` +
                ...
                <DropdownMenu.Item>
                    <button
                        ...
                        className={
                            `flex items-center gap-x-2 w-full px-3 py-2 rounded-md ` +
                            (!userProfile?.phoneNumber || userProfile.phoneNumber === "No Disponible"
                                ? "opacity-50 cursor-not-allowed"
                                : "hover:bg-gray-200 hover:text-gray-800")
                        }
...
export default DropdownContactButton;
